...
import { useGrid, Direction, State } from '../play'
import type { CellPosition } from '../play'
...
const getCellStyle = (cell: CellPosition) => {
    ...
    <main class="grid-main" ref="gridRef" :style="gridStyle">
      ...
      <div
        ...
        :class="{
          ...
          'cell-merge': cell.state === State.MERGE,
          'cell-new': cell.state === State.NEW,
        }"
